...
const messages = {
  ko: {
    ...
    channel: {
      ...
      requestPresent: '발표 요청',
      takePresent: '발표 가져오기',
      stopPresent: '발표 종료',
      presentRequested: '발표 요청을 보냈습니다. 방장의 승인을 기다리는 중입니다.',
      presentRequestMsg: '{name} 님이 발표를 요청했습니다.',
      presentEnded: '발표를 종료했습니다.',
      startPresentTitle: '발표자가 되었습니다. 공유할 화면을 선택해 주세요.',
      startPresent: '발표 시작',
      approve: '승인',
      deny: '거절',
      fullscreen: '전체화면',
  ...
  en: {
    ...
    channel: {
      ...
      requestPresent: 'Request to present',
      takePresent: 'Take presenting',
      stopPresent: 'Stop presenting',
      presentRequested: 'Your request to present was sent. Waiting for the host to approve.',
      presentRequestMsg: '{name} wants to present.',
      presentEnded: 'You stopped presenting.',
      startPresentTitle: 'You are now the presenter. Choose a screen to share.',
      startPresent: 'Start presenting',
      approve: 'Approve',
      deny: 'Deny',
