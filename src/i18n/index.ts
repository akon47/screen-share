...
const messages = {
  ko: {
    ...
    channel: {
      ...
      exit: '나가기',
      startShare: '화면 공유하기',
      startShareHint: '공유할 화면이나 창을 선택하세요.',
      changeShare: '화면 변경',
      stopShare: '공유 중지',
      sharePaused: '화면 공유를 중지했습니다.',
      waitingHost: '호스트가 화면 공유를 시작하길 기다리는 중입니다…',
      hostLeaveConfirm: '나가면 방이 종료되고 모든 참여자의 연결이 끊깁니다. 정말 나가시겠어요?',
  ...
  en: {
    ...
    channel: {
      ...
      exit: 'Exit',
      startShare: 'Share a screen',
      startShareHint: 'Choose a screen or window to share.',
      changeShare: 'Change screen',
      stopShare: 'Stop sharing',
      sharePaused: 'You stopped sharing.',
      waitingHost: 'Waiting for the host to start sharing…',
      hostLeaveConfirm: 'Leaving will end the room and disconnect everyone. Are you sure you want to leave?',
